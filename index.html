...
const EQUI_IMAGE_FRAMES = {
  "ink-circle": { src: FRAME_IMAGE_BASE+"frame-ink-circle.png", shape:"clip", inset:{top:0,left:0,right:0,bottom:0}, clipPath:"polygon(59.84% 9.44%, 43.40% 11.67%, 31.60% 18.44%, 20.83% 28.67%, 25.23% 20.00%, 18.52% 28.33%, 19.44% 23.89%, 17.25% 27.00%, 17.01% 25.11%, 13.43% 28.22%, 18.63% 19.56%, 8.33% 31.67%, 5.32% 48.11%, 3.82% 45.89%, 4.63% 58.67%, 1.74% 60.22%, 3.47% 60.00%, 3.94% 62.44%, 5.44% 60.56%, 11.69% 74.33%, 12.50% 72.89%, 28.01% 85.00%, 38.89% 89.22%, 58.10% 88.78%, 73.38% 82.11%, 81.02% 73.89%, 86.81% 63.67%, 84.84% 70.56%, 89.35% 67.22%, 87.73% 65.78%, 89.12% 61.67%, 90.86% 63.00%, 90.86% 48.44%, 85.53% 31.78%, 76.85% 18.67%)" },
